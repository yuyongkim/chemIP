                ...
                <div className="flex justify-between h-16 items-center">
                    ...
                    <div className="hidden md:flex items-center gap-1">
                        ...
                        <button
                            ...
                            className="flex items-center gap-1 px-3 py-2.5 min-h-[44px] rounded-lg text-xs font-bold border border-gray-200 hover:bg-gray-50 transition-all"
                    ...
                    <div className="md:hidden flex items-center gap-2">
                        <Link href="/drugs" className="inline-flex items-center justify-center w-11 h-11 rounded-lg text-gray-500 hover:text-blue-600 hover:bg-blue-50 transition-all" aria-label={t('nav.drugs')}>
                            <Pill className="w-5 h-5" />
                        </Link>
                        <Link href="/trade" className="inline-flex items-center justify-center w-11 h-11 rounded-lg text-gray-500 hover:text-emerald-600 hover:bg-emerald-50 transition-all" aria-label={t('nav.trade')}>
                            <Globe2 className="w-5 h-5" />
                        </Link>
                        <button
                            onClick={() => setLocale(locale === 'en' ? 'ko' : 'en')}
                            className="inline-flex items-center justify-center w-11 h-11 rounded-lg text-xs font-bold text-gray-500 hover:bg-gray-50 border border-gray-200 transition-all"
