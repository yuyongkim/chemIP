                ...
                <div className="flex justify-between h-16 items-center">
                    <Link href="/" className="flex items-center gap-2.5 group">
                        ...
                        <div className="flex flex-col">
                            ...
                            <span className="text-[10px] font-medium text-gray-400 leading-tight tracking-wider uppercase">
                                Platform
                            </span>
                        </div>
                    </Link>
                    ...
                    <div className="hidden md:flex items-center gap-1">
                        ...
                        <Link href="/docs" className="flex items-center gap-1.5 px-3 py-2 rounded-lg text-sm font-medium text-gray-400 hover:text-gray-600 hover:bg-gray-50 transition-all duration-150">
                    ...
                    <div className="md:hidden flex items-center gap-2">
                        <Link
                            href="/drugs"
                            className="inline-flex items-center justify-center w-9 h-9 rounded-lg text-gray-500 hover:text-blue-600 hover:bg-blue-50 transition-all"
                            aria-label="Drugs"
                        >
                        ...
                        <Link
                            href="/trade"
                            className="inline-flex items-center justify-center w-9 h-9 rounded-lg text-gray-500 hover:text-emerald-600 hover:bg-emerald-50 transition-all"
                            aria-label="Trade Intelligence"
                        >
