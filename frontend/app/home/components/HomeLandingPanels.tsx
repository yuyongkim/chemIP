      ...
      <section className="stagger-in space-y-5">
          ...
          <div className="flex items-start gap-5">
            ...
            <div className="flex-1">
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="text-[10px] font-semibold text-[#1e3a5f] bg-slate-100 px-2 py-0.5 rounded">핵심 기능</span>
              </div>
              <p className="text-sm text-gray-500 leading-relaxed max-w-lg">한국산업안전보건공단(KOSHA) 공식 물질안전보건자료 13,448종의 16개 섹션 전문을 조회하고, 관련 특허/무역/규제 정보를 교차 분석합니다.</p>
              <div className="flex items-center gap-4 mt-4">
                <div className="flex items-center gap-1 text-[#1e3a5f] text-sm font-semibold group-hover:gap-1.5 transition-all duration-200">
                  MSDS 검색 시작
                  <ArrowUpRight className="w-3.5 h-3.5" />
                </div>
                <span className="text-xs text-gray-400">GHS 분류 / 유해위험성 / 취급 및 저장 / 노출방지 등</span>
              </div>
            </div>
          </div>
        </Link>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          ...
          >
            ...
            <h3 className="text-base font-bold text-gray-900 mb-1 tracking-tight">의약품 통합 검색</h3>
            <p className="text-sm text-gray-500 leading-relaxed">MFDS 허가/일반의약품 + OpenFDA + PubMed 논문을 통합 조회합니다.</p>
            <div className="flex items-center gap-1 mt-4 text-emerald-600 text-sm font-semibold group-hover:gap-1.5 transition-all duration-200">
              의약품 검색
              <ArrowUpRight className="w-3.5 h-3.5" />
            </div>
          </Link>
          ...
          >
            ...
            <h3 className="text-base font-bold text-gray-900 mb-1 tracking-tight">무역 / 시장 정보</h3>
            <p className="text-sm text-gray-500 leading-relaxed">KOTRA 해외시장뉴스, 가격동향, 진출전략, 무역사기 정보를 분석합니다.</p>
            <div className="flex items-center gap-1 mt-4 text-cyan-600 text-sm font-semibold group-hover:gap-1.5 transition-all duration-200">
              무역 데이터
              <ArrowUpRight className="w-3.5 h-3.5" />
            </div>
          </Link>
